...
import helixtrajectory.drive.swerve_drive as swerve_drive
from helixtrajectory.trajectory_generator import trajectory_generator
...
def main():
    ...
    parser.add_argument('--out', '-o', default=None, help='Output file location')
    args = parser.parse_args()

    file_path = args.input
    selected_path = args.pathname
